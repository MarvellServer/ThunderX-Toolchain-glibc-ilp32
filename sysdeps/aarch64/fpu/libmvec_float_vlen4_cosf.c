...
__scalar_cosf (float32x4_t x)
{
  return (float32x4_t) { cosf(x[0]), cosf(x[1]), cosf(x[2]), cosf(x[3]) };
}

__attribute__((aarch64_vector_pcs))
__Float32x4_t _ZGVnN4v_cosf(__Float32x4_t x)
{
  __Float32x4_t c;
